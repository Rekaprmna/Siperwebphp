  ...
  <body>
    ...
    <div class="sidebar">
      ...
      <ul>
        ...
        <li>
          <a href="datasekolah.php" class="active"><i class="fas fa-school"></i> Data Sekolah</a>
        </li>
        <li>
          <a href="databuku.php"><i class="fas fa-book"></i> Data Buku</a>
        </li>
        <li>
          <a href="peminjaman.php"><i class="fas fa-sign-out-alt"></i> Peminjaman</a>
        </li>
        <li>
      ...
      <table>
        ...
        <tbody>
          <tr>
            ...
            <td><button onclick="window.location.href='buku.php'">Lihat Data</button></td>
            <td>
